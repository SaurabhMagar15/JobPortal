...
const JobDescription = () => {
    ...
    // Add null check for singleJob
    const isInitiallyApplied = singleJob?.applications?.some(application => application.application === user?._id) || false;
        ...
        try {
            ...
            if (res.data.success) {
                ...
                const updatedSingleJob = { 
                    ...singleJob, 
                    applications: [...(singleJob.applications || []), { application: user?._id }] 
                }
        ...
        const fetchSingleJobs = async () => {
            try {
                ...
                if (res.data.success) {
                    ...
                    setIsApplied(res.data.job.applications?.some(application => application.application === user?._id) || false)
                }
            } catch (error) {
                console.log(error)
            }
